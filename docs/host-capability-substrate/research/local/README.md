...
| `2026-05-06-phase-2-7-deferred-lane-sequencing-plan.md` | 2026-05-06 | Docs-only sequencing plan tying the accepted Q-013 and Q-014 deferred implementation lanes together. Keeps ADR 0038 intact, records the default Q-013-before-Q-014 order, and requires a separate sequencing amendment for acceleration. |
