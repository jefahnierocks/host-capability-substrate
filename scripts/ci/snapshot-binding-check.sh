...
SNAPSHOT_PATH = 'policies/generated-snapshot/tiers.yaml'
BINDING_PATH = 'policies/generated-snapshot/snapshot-binding.json'
...
yaml_snapshots = Dir.glob('policies/generated-snapshot/**/*.{yaml,yml}').sort
unless yaml_snapshots == [SNAPSHOT_PATH]
  fail_check("expected only #{SNAPSHOT_PATH} under policies/generated-snapshot/, found #{yaml_snapshots.join(', ')}")
end
